              ...
              <!-- Title Name -->
                ...
                <div class="nav-scroller border-bottom">
                  ...
                  <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" data-toggle="tab" href="#schedule-service" onClick="storeTabId('service')">Schedule Service</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" data-toggle="tab" href="#client-projects" onClick="storeTabId('complain')">Sent for Service</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" data-toggle="tab" href="#outlet-section">Outlet Section</a>
                    </li>

                      <li class="nav-item">
                          <a class="nav-link" data-toggle="tab" href="#outlet-agreement">Outlet Agreement</a>
                      </li>

                    <li class="nav-item">
                      <a class="nav-link" data-toggle="tab" href="#client-expenses">Employee</a>
                    </li>
                ...
                <div class="tab-content pt-4" id="clientDetailsTabs">
                  ...
                  <div class="tab-pane fade show active" id="client-billing-contact" role="tabpanel" aria-labelledby="client-billing-contact-tab">
                    ...
                    <div class="card">
                      ...
                      <div class="masonry-layout">
                          ...
                          <div class="masonry-item col-lg-6">
                                    <div class="d-flex justify-content-between align-items-center">
                                      <h2 id="client-billing-contact-tab" class="card-title"> Land Owner Info </h2>
                                    </div>
                                    <strong>Mr. Jamal Hossen</strong>
                                    <address> Level-7, Block: C, Panthapath, Dhaka.
                                    <br>Mobile: 01678-614819 <br> Bangladesh </address>
                          </div>
                    ...
                    <div class="card mt-4">
                      <!-- .card-body -->
                      <div class="card-body">
                        <h2 class="card-title"> Outlet Employee Information </h2><!-- .table-responsive -->
                        <div class="table-responsive">
                          <table class="table table-hover" style="min-width: 678px">
                            ...
                            <tbody>
                              <tr>
                                <td class="align-middle">Mr. Jamal Hossen </td>
                                <td class="align-middle"> Permanent </td>
                              ...
                              <tr>
                                <td class="align-middle">Mr. Kamal Hossen </td>
                                <td class="align-middle"> Contractual </td>
                                <td class="align-middle"> (062) 109-9222 </td>
                                <td class="align-middle text-right">
                                  <button type="button" class="btn btn-sm btn-icon btn-secondary" data-toggle="modal" data-target="#clientContactEditModal"><i class="fa fa-pencil-alt"></i> <span class="sr-only">Edit</span></button> <button type="button" class="btn btn-sm btn-icon btn-secondary"><i class="far fa-trash-alt"></i> <span class="sr-only">Remove</span></button>
                                </td>
                  ...
                  <!-- .tab-pane Schedule Tab -->
                  <div class="tab-pane fade" id="schedule-service" role="tabpanel" aria-labelledby="schedule-service-tab">
                              ...
                              <table class="table">
                                  ...
                                  <tr>
                                      ...
                                      <td class="align-middle">
                                          <a href="#">Hitachi Deluxe Series Split Air Conditioner – 2 Ton</a>
                                      </td>
                                      <td class="align-middle">
                                          <span class="badge badge-subtle badge-success">2022-06-05</span>
                                      </td>
                                      <td class="align-middle text-right">
                                  ...
                                  <tr>
                                      <td class="align-middle col-checker">
                                          <div class="custom-control custom-control-nolabel custom-checkbox">
                                              <input type="checkbox" class="custom-control-input" id="cid5744"> <label class="custom-control-label" for="cid5744"></label>
                                          </div>
                                      </td>
                                      <td class="align-middle px-0" style="width: 1.5rem">
                                          <button type="button" class="btn btn-sm btn-icon btn-light" data-toggle="collapse" data-target="#details-cid5744"><span class="collapse-indicator"><i class="fa fa-angle-right"></i></span></button>
                                      </td>
                                      <td class="align-middle">
                                          <a href="#">Hitachi Deluxe Series Split Air Conditioner – 2 Ton</a>
                                      </td>
                                  ...
                                  <!-- tr -->
                                  <tr class="row-details bg-light collapse" id="details-cid5744">
                                      <td colspan="6">
                                          <!-- .row -->
                                          <div class="row">
                                              <!-- .col -->
                                              <div class="col-md-auto text-center">
                                                  <div class="tile tile-xl tile-circle bg-purple mb-2"> O </div>
                                                  <h3 class="card-title mb-4"> 100920 </h3>
                                              </div><!-- /.col -->
                                              <!-- .col -->
                                              <div class="col-md-7">
                                                  <table class="table table-bordered table-striped">
                              ...
                              <div class="table-responsive">
                                  ...
                                  <table class="table">
                                      ...
                                      <tr>
                                          <td class="align-middle col-checker">
                                              <div class="custom-control custom-control-nolabel custom-checkbox">
                                                  <input type="checkbox" class="custom-control-input" id="cid5753"> <label class="custom-control-label" for="cid5753"></label>
                                              </div>
                                          </td>
                                          <td class="align-middle px-0" style="width: 1.5rem">
                                              <button type="button" class="btn btn-sm btn-icon btn-light" data-toggle="collapse" data-target="#details-cid5753"><span class="collapse-indicator"><i class="fa fa-angle-right"></i></span></button>
                                          </td>
                                          <td class="align-middle">
                                              <a href="#">Hitachi Deluxe Series Split Air Conditioner – 2 Ton</a>
                                          </td>
                                      ...
                                      <!-- tr -->
                                      <tr class="row-details bg-light collapse" id="details-cid5753">
                                          <td colspan="6">
                                              <!-- .row -->
                                              <div class="row">
                                                  <!-- .col -->
                                      ...
                                      <tr>
                                          <td class="align-middle col-checker">
                                              <div class="custom-control custom-control-nolabel custom-checkbox">
                                                  <input type="checkbox" class="custom-control-input" id="cid5754"> <label class="custom-control-label" for="cid5754"></label>
                                              </div>
                                          </td>
                                          <td class="align-middle px-0" style="width: 1.5rem">
                                              <button type="button" class="btn btn-sm btn-icon btn-light" data-toggle="collapse" data-target="#details-cid5754"><span class="collapse-indicator"><i class="fa fa-angle-right"></i></span></button>
                                          </td>
                                          <td class="align-middle">
                                              <a href="#">Hitachi Deluxe Series Split Air Conditioner – 2 Ton</a>
                                          </td>
                                      ...
                                      <tr>
                                          <td class="align-middle col-checker">
                                              <div class="custom-control custom-control-nolabel custom-checkbox">
                                                  <input type="checkbox" class="custom-control-input" id="cid5746"> <label class="custom-control-label" for="cid5746"></label>
                                              </div>
                                          </td>
                                          <td class="align-middle px-0" style="width: 1.5rem">
                                              <button type="button" class="btn btn-sm btn-icon btn-light" data-toggle="collapse" data-target="#details-cid5746"><span class="collapse-indicator"><i class="fa fa-angle-right"></i></span></button>
                                          </td>
                                          <td class="align-middle">
                                              <a href="#">Hitachi Deluxe Series Split Air Conditioner – 2 Ton</a>
                                          </td>
                                      ...
                                      <!-- tr -->
                                      <tr class="row-details bg-light collapse" id="details-cid5746">
                                          <td colspan="6">
                                              <!-- .row -->
                                              <div class="row">
                                                  <!-- .col -->
                                      ...
                                      <tr>
                                          <td class="align-middle col-checker">
                                              <div class="custom-control custom-control-nolabel custom-checkbox">
                                                  <input type="checkbox" class="custom-control-input" id="cid5747"> <label class="custom-control-label" for="cid5747"></label>
                                              </div>
                                          </td>
                                          <td class="align-middle px-0" style="width: 1.5rem">
                                              <button type="button" class="btn btn-sm btn-icon btn-light" data-toggle="collapse" data-target="#details-cid5747"><span class="collapse-indicator"><i class="fa fa-angle-right"></i></span></button>
                                          </td>
                                          <td class="align-middle">
                                              <a href="#">Hitachi Deluxe Series Split Air Conditioner – 2 Ton</a>
                                          </td>
                                      ...
                                      <!-- tr -->
                                      <tr class="row-details bg-light collapse" id="details-cid5747">
                                          <td colspan="6">
                                              <!-- .row -->
                                              <div class="row">
                                                  <!-- .col -->
                  ...
                  <!-- .tab-pane Outlet Section Tab -->
                  <div class="tab-pane fade" id="outlet-section" role="tabpanel" aria-labelledby="outlet-section-tab">
                    <!-- .card -->
                    <div class="card">
                      <!-- .card-header -->
                      ...
                      <div class="table-responsive">
                          ...
                          <tr>
                              ...
                              <th style="min-width:320px"> Section Name </th>
                          </tr>
                          </thead><!-- /thead -->
                          <!-- tbody -->
                          <tbody>
                ...
                <!-- tab-pane Outlet Agreement Tab -->
                    <div class="tab-pane fade" id="outlet-agreement" role="tabpanel" aria-labelledby="outlet-agreement-tab">
                        <!-- .card -->
                        <div class="card">
                            <!-- .card-header -->
                            <div class="card-header d-flex">
                                <button type="button" class="btn btn-primary ml-auto" data-toggle="modal" data-target="#outletAgreementForm">New Agreement</button>
                            </div><!-- /.card-header -->
                            <!-- .table-responsive -->
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-right">
                                            ...
                                            </a> <a href="#" class="btn btn-sm btn-icon btn-secondary">
                                                <i class="far fa-trash-alt"></i> <span class="sr-only">Remove</span></a>
                                        </td>
                                    </tr><!-- /tr -->
                                    <!-- tr -->
