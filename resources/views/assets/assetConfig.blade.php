...
<div class="page-inner">
        ...
        <!-- <div class="card"> -->
            ...
            <div class="nav-scroller border-bottom">
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active show" data-toggle="tab" href="#asset-group-tab-content" onClick="storeTabId('basicInfo')">Asset Group</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#asset-sub-group-tab-content" onClick="storeTabId('service')">Asset Sub-Group</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="tab-content mt-4" id="asset-group-tab">
            ...
            <!-- .tab-pane -->
            <div class="tab-pane fade show active" id="asset-group-tab-content" role="tabpanel" aria-labelledby="asset-group-tab-content">
