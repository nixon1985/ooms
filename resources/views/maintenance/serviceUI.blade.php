    ...
    <div class="tab-content pt-4" id="clientDetailsTabs">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                <h4 class="list-group-item-title text-truncate" data-target="#details-cid5743">
                                    <a href="#">Our trip to Montreal</a>
                                </h4>
                            </td>
                            <td class="align-middle"> GULSHAN PINK CITY </td>
                            <td class="align-middle">
                                        ...
                                        <div class="publisher keep-focus focus">
                                            ...
                                            <div class="publisher-actions align-items-center">
                                                <div class="el-example">
                                                    <button type="button" class="btn btn-info ml-auto" data-toggle="modal" data-target="#followingModal">Serviceable </button>
                                                    <button type="button" class="btn btn-danger">Unserviceable</button>
        ...
        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
            ...
            <div class="card-header d-flex">
                ...
                <button type="button" class="btn btn-primary ml-auto" data-toggle="modal" data-target="#followingModal">Service request</button>
            </div><!-- /.card-header -->
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td class="align-middle px-0" style="width: 1.5rem">
                                <button type="button" class="btn btn-sm btn-icon btn-light" data-toggle="collapse" data-target="#service-cid5743"><span class="collapse-indicator"><i class="fa fa-angle-right"></i></span></button>
                            </td>
                            <td class="align-middle">
                        ...
                        <!-- tr -->
                        <tr class="row-details bg-light collapse" id="service-cid5743">
                            <td colspan="5">
                                <!-- .row -->
                                <div class="row">
                                    <!-- .col -->
                        ...
                        <tr>
                            <td class="align-middle px-0" style="width: 1.5rem">
                                <button type="button" class="btn btn-sm btn-icon btn-light" data-toggle="collapse" data-target="#service-cid5476"><span class="collapse-indicator"><i class="fa fa-angle-right"></i></span></button>
                            </td>
                            <td class="align-middle">
                                <a href="#">Codehow</a>
                            </td>
                        ...
                        <!-- tr -->
                        <tr class="row-details bg-light collapse" id="service-cid5476">
                            <td colspan="5">
                                <!-- .row -->
                                <div class="row">
                                    <!-- .col -->
                        ...
                        <tr>
                            <td class="align-middle px-0" style="width: 1.5rem">
                                <button type="button" class="btn btn-sm btn-icon btn-light" data-toggle="collapse" data-target="#service-cid4423"><span class="collapse-indicator"><i class="fa fa-angle-right"></i></span></button>
                            </td>
                            <td class="align-middle">
                                <a href="#">Ron-tech</a>
                            </td>
                        ...
                        <!-- tr -->
                        <tr class="row-details bg-light collapse" id="service-cid4423">
                            <td colspan="5">
                                <!-- .row -->
                                <div class="row">
                                    <!-- .col -->
