            ...
            <div class="top-bar-item top-bar-item-right px-0 d-none d-sm-flex">
              ...
              <div class="dropdown d-none d-md-flex">
                ...
                <div class="dropdown-menu">
                  ...
                  <h6 class="dropdown-header d-none d-md-block d-lg-none"> Beni Arisandi </h6><a class="dropdown-item" href="user-profile.html"><span class="dropdown-icon oi oi-person"></span> Profile</a> <a class="dropdown-item" href="login"><span class="dropdown-icon oi oi-account-logout"></span> Logout</a>
